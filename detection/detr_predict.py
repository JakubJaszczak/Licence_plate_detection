...
if __name__ == "__main__":
    ...
    image_processor = AutoImageProcessor.from_pretrained("./detr_high_patience", use_fast=True)
    model = AutoModelForObjectDetection.from_pretrained("./detr_high_patience")
    ...
    for image_path in tqdm(
        Path(r"D:\praca_magisterska\project\Licence_plate_detection\datasets\licence_plate\images\test").iterdir()
    ):
        ...
        with image_root_dir.joinpath("results_pixel_coordinates.txt").open("w") as f:
            f.write("\n".join(txt_output_pixels))
